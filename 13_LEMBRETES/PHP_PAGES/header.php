                ...
                <?php if($_SESSION['perfil_id'] == 2){?>
                    ...
                    <div class="collapse submenu" id="lembrete">
                        <li class="nav-item " style="background-color: black">
                            <a href="../index.php" class="text-white p-3 pl-4" style="text-decoration: none; display: block">
                        ...
                        <li class="nav-item border-top" style="background-color: black">
                            <a href="../PHP_PAGES/nova_tarefa.php" class="text-white p-3 pl-4" style="text-decoration: none; display: block">
                                <span class="fa fa-angle-right" style="font-size: 20px;"></span> <span style="font-size: 14px; margin-left: 5px;">Novo lembrete</span>
                            </a>
                        </li>

                        <li class="nav-item border-top" style="background-color: black">
                            <a href="../PHP_PAGES/todas_tarefas.php" class="text-white p-3 pl-4" style="text-decoration: none; display: block">
