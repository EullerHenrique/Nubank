...
<html lang="pt-br">
	<head>
		...
		<title>Nubank - Todos lembretes</title>
        ...
        <script>
           function editar(id, txt_tarefa) {
               ...
               form.action = "../PHP_SCRIPTS/Tarefa_controller.php?acao=atualizar";
               form.method = 'post';
               form.className ='row';
			...
			<div class="row">
				<div class="col-md-3 mb-4">
					<ul class="list-group">
						...
						<li class="list-group-item"><a href="nova_tarefa.php">Novo lembrete</a></li>
						<li class="list-group-item active"><a href="#">Todos lembretes</a></li>
					</ul>
				</div>
				...
				<div class="col-md-9">
					<div id = "pagina" class="container">
						<div class="row">
							<div class="col">
								<h4 class="roxo">Todos lembretes de pagamentos</h4>
								<hr>
                                ...
                                <?php foreach ($tarefas_bd as $indice => $tarefa_bd){ ?>
                                    <div class="row mb-3 tarefa">
                                        ...
                                        <div class="col-12 mt-2 d-flex justify-content-between">
                                            ...
                                            <form action="../PHP_SCRIPTS/Tarefa_controller.php?acao=remover" method="post">
                                            ...
                                            <?php if ($tarefa_bd->status == 'pendente'){ ?>
                                                <div>
                                                ...
                                                <form action="../PHP_SCRIPTS/Tarefa_controller.php?acao=realizado" method="post">
