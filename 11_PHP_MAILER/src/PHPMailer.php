<?php
/**
 * PHPMailer - PHP_SCRIPTS email creation and transport class.
 * PHP_SCRIPTS Version 5.5
 *
 * @package   PHPMailer
...
class PHPMailer
{
    ...
    /**
     * An PHP_PAGES or plain text message body.
     * If PHP_PAGES then call isHTML(true).
     *
     * @var string
     */
    public $Body = '';
     ...
     * This body can be read by mail clients that do not have PHP_PAGES email
     * capability such as mutt & Eudora.
     * Clients that can read PHP_PAGES will view the normal Body.
     *
     * @var string
     */
    public $AltBody = '';
     ...
     * Be aware that in PHP_SCRIPTS >= 5.6 this requires that the server's certificates are valid.
     *
     * @var boolean
     */
     ...
     * The default validator uses PHP_SCRIPTS's FILTER_VALIDATE_EMAIL filter_var option.
     *
    ...
    protected function edebug($str)
    {
        ...
        switch ($this->Debugoutput) {
            case 'error_log':
                ...
                break;
            case 'html':
                //Cleans up output a bit for a better looking, PHP_PAGES-safe output
                echo htmlentities(
                    preg_replace('/[\r\n]+/', '', $str),
                    ENT_QUOTES,
                    'UTF-8'
    ...
    /**
     * Sets message type to PHP_PAGES or plain.
     *
     * @param boolean $isHtml True for PHP_PAGES mode.
     */
    ...
    /**
     * Send messages using PHP_SCRIPTS's mail() function.
     */
     ...
     * * `php` Use PHP_SCRIPTS built-in FILTER_VALIDATE_EMAIL;
     ...
     * `intl` and `mbstring` PHP_SCRIPTS extensions.
     *
     ...
     * - Conversion to punycode is impossible (e.g. required PHP_SCRIPTS functions are not available)
    ...
    public function punyencodeAddress($address)
    {
        ...
        if ($this->idnSupported() and
            ...
            if ($this->has8bitChars($domain) and @mb_check_encoding($domain, $this->CharSet)) {
                ...
                //Ignore IDE complaints about this line - method signature changed in PHP_SCRIPTS 5.4
                $errorcode = 0;
    ...
    public function preSend()
    {
        ...
        //Check for buggy PHP_SCRIPTS versions that add a header with an incorrect line break
        if (ini_get('mail.add_x_header') == 1
            ...
            trigger_error(
                'Your version of PHP_SCRIPTS is affected by a bug that may result in corrupted messages.' .
                ' To fix it, switch to sending using SMTP, disable the mail.add_x_header option in' .
                ' your php.ini, switch to MacOS or Linux, or upgrade your PHP_SCRIPTS to version 7.0.17+ or 7.1.3+.',
                E_USER_WARNING
            );
        }
    ...
    /**
     * Send mail using the PHP_SCRIPTS mail() function.
     *
     * @param string $header The message headers
     * @param string $body The message body
     *
     ...
     * You should only do this to plain-text bodies as wrapping PHP_PAGES tags may break them.
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                //Workaround for PHP_SCRIPTS bug https://bugs.php.net/bug.php?id=69197
     ...
     * This is used in PHP_PAGES messages that embed the images
     * the PHP_PAGES refers to using the $cid value.
     * Never use a user-supplied path to a file!
     *
     * @param string $path Path to the attachment.
     * @param string $cid Content ID of the attachment; Use this to reference
     *        the content when using an embedded image in PHP_PAGES.
     * @param string $name Overrides the attachment name.
     * @param string $encoding File encoding (see $Encoding).
    ...
    /**
     * Create a message body from an PHP_PAGES string.
     * Automatically inlines images and creates a plain-text version by converting the PHP_PAGES,
     * overwriting any existing values in Body and AltBody.
     * Do not source $message content from user input!
     * $basedir is prepended when handling relative URLs, e.g. <IMG2 src="/images/a.png"> and must not be empty
     * will look for an image file in $basedir/images/a.png and convert it to inline.
     * If you don't provide a $basedir, relative paths will be left untouched (and thus probably break in email)
     * Converts data-uri images into embedded attachments.
     * If you don't want to apply these transformations to your PHP_PAGES, just set Body and AltBody directly.
     *
     * @access public
     * @param string $message PHP_PAGES message string
     * @param string $basedir Absolute path to a base directory to prepend to relative paths to images
     * @param boolean|callable $advanced Whether to use the internal PHP_PAGES to text converter
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
    {
        ...
        if (!$this->alternativeExists()) {
            $this->AltBody = 'This is an PHP_PAGES-only message. To view it, activate PHP_PAGES in your email application.'
                . static::$LE;
        }
        return $this->Body;
    }
    ...
    /**
     * Convert an PHP_PAGES string into plain text.
     ...
     * </code>
     *
     * @param string $html The PHP_PAGES text to convert
