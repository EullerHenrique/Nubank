...
class SMTP
{
    ...
    public function startTLS()
    {
        ...
        //PHP_SCRIPTS 5.6.7 dropped inclusion of TLS 1.1 and 1.2 in STREAM_CRYPTO_METHOD_TLS_CLIENT
     ...
     *
     * @param integer $errno The error number returned by PHP_SCRIPTS.
     * @param string $errmsg The error message returned by PHP_SCRIPTS.
