    ...
    ?>
        ...
        <header> <!-- Inicio cabeçalho -->
            <nav class="navbar navbar-expand-md navbar-light" style="background: #8A05BE;">
                ...
                <div class="container">
                    <a class=navbar-brand" href="https://nubank.com.br/">
                    ...
                    <div class="collapse navbar-collapse ml-4" id="nav-principal">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a href="pagamento.php" class="nav-link">Agendamento de pagamentos</a>
                            </li>

                            <li class="nav-item">
                                <a href="consulta.php" class="nav-link">Histórico de agendamentos</a>
                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col mt-5 mb-5 d-flex justify-content-center">
                    <h1 class="display-5">Novo Pagamento</h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end mb-2">
                    <button type="button" class="btn btn-lg btn-block btn-primary" onclick="cadastrarPagamento()">
